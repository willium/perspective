...
export default function(Module) {
    ...
    table.prototype._is_valid_filter = function(filter) {
        ...
        if (filter[1] === perspective.FILTER_OPERATORS.isNull ||
            filter[1] === perspective.FILTER_OPERATORS.isNotNull) { return true; }
        ...
        return typeof value !== "undefined" && value !== null && filter[2] !== "";
    };
